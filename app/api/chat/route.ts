...
export async function POST(req: Request) {
  ...
  if (mode === "route") {
    ...
    system = [
      ...
      "候補にないスポットを作らないでください。",
      "距離・所要時間・合計時間の数字は書かないでください（「約350m」「徒歩5分」「合計2時間30分」など）。これらはアプリが座標から計算して画面に表示します。数字の代わりに「すぐ近く」「少し歩きます」のような言い方をしてください。",
      ...
      "・立ち寄り数は、利用者の条件で指定された範囲に従ってください。気分だけで勝手に減らさないでください（『半日・ゆったり』で3か所だけにすると、2時間近く余ります）。",
      ...
      "回答形式: ルート名 / 立ち寄り順 / この順にした理由 / 途中変更の案内 / 注意事項。距離と時間の欄は作らないでください（アプリが計算して立ち寄り先の下に表示します）。",
